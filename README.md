# 📱 OffSub (오프서브)
> **On-Device AI Subscription Management**  
> 사용자의 프라이버시를 최우선으로 생각하는 온디바이스 AI 기반 구독 관리 플랫폼
...
| 홈 화면 | 서비스 관리 |
| :---: | :---: |
| <img src="assets/images/홈화면.png" width="260"> | <img src="assets/images/서비스관리 화면.png" width="260"> |
| **구독 현황 및 소비 요약** | **구독 서비스 추가 및 해지 관리** |
| **파티션 분석** | **설정** |
| <img src="assets/images/파티션 분석 화면.png" width="260"> | <img src="assets/images/설정 화면.png" width="260"> |
| **앱 사용량 기반 미사용 구독 탐지** | **온디바이스 AI 및 보안 설정** |
